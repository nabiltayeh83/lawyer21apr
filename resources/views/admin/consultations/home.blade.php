        ...
        <div class="portlet-body">
            <div class="table-toolbar">
                ...
                <div class="row">
                    <div class="col-sm-9">
                        <div class="btn-group">
                            <a href="{{url(getLocal().'/admin/consultations/create')}}" style="margin-right: 5px" class="btn sbold green">
                               {{__('cp.add')}}
                    ...
                    <tr class="odd gradeX" id="tr-{{$item->id}}">
                        ...
                        <td>
                            <div class="btn-group btn-action">
                                <a href="{{url(getLocal().'/admin/consultations/'.$item->id.'/edit')}}"
...
@section('script')
    <script>
        ...
        function delete_adv(id,iss_id, e) {
            ...
            console.log(id);
            console.log(iss_id);
            var url = '{{url(getLocal()."/admin/consultations")}}/' + id;
