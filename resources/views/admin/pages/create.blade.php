        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    <form method="post" action="{{url(app()->getLocale().'/admin/pages')}}" enctype="multipart/form-data" class="form-horizontal" role="form">
                        {{ csrf_field() }}
                            ...
                            @foreach($locales as $locale)
                                <fieldset>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" class="form-control" name="title_{{$locale->lang}}" value="" id="order" placeholder=" {{__('cp.title_'.$locale->lang.'')}}" {{ old('title_'.$locale->lang) }}>
                            ...
                            @foreach($locales as $locale)
                                <fieldset>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <textarea class="ckeditor form-control" name="description_{{$locale->lang}}" value="" id="order" placeholder=" {{__('cp.description_'.$locale->lang.'')}}" {{ old('description_'.$locale->lang) }}>
                                            </textarea>
                                            <span class="help-inline"> * required </span>
                                        </div>
                                    </div>
                            ...
                            @foreach($locales as $locale)
                                <fieldset>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" class="form-control" name="key_words_{{$locale->lang}}" value="" id="order" placeholder=" {{__('cp.key_words_'.$locale->lang.'')}}" {{ old('key_words_'.$locale->lang) }}>
                                            <span class="help-inline"> * required </span>
                                        </div>
                                    </div>
                                </fieldset>
