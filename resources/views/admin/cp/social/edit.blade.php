        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-title">
                    ...
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark sbold uppercase"
                              ...
                              {{__('cp.edit')}}{{__('cp.social_media')}}</span>
                ...
                <div class="portlet-body form">
                    ...
                    <form method="post" action="{{url(app()->getLocale().'/admin/social_media/'.$item->id)}}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="bio"
                                               ...
                                               id="bio" value="{{$item->bio}}" required>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select id="social_category_id" class="form-control select2"
                                            ...
                                            @foreach($social_categories as $social_category)
                                                ...
                                                <option value="{{$social_category->id}}"

                                                        {{ ($item->social_category_id == $social_category->id ? "selected":"") }}>
