                ...
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark sbold uppercase" style="color: #e02222 !important;">
                            {{__('cp.edit')}}{{__('cp.country')}}
                        </span>
                    </div>
                </div>

                <div class="portlet-body form">
                    <form method="post" action="{{url(app()->getLocale().'/admin/countries/'.$item->id)}}" enctype="multipart/form-data" class="form-horizontal" role="form">
                        {{ csrf_field() }}
                        {{ method_field('PATCH')}}
                        <div class="form-body">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" name="code" placeholder="{{__('cp.code')}}" id="code" value="{{ $item->code }}" required>
                                    </div>
                                </div>
                            </fieldset>      
