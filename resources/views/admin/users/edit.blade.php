...
@section('content')
    <div class="row">
                ...
                <div class="portlet-title">
                    <div class="caption">
                        ...
                        <span class="caption-subject font-dark sbold uppercase" style="color: #e02222 !important;">
                            {{__('cp.edit')}} {{__('cp.user')}}
                        </span>
                    </div>
                </div>
                <div class="portlet-body form">
                    <form method="post" action="{{route('admin.users.update',$item->id)}}" enctype="multipart/form-data" class="form-horizontal" role="form" id="form_company">
                    {{ csrf_field() }}
                    {{ method_field('PATCH')}}
                    ...
                    <fieldset>
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="name" placeholder="{{__('cp.name')}}"  value="{{$item->name}}" required>
                            </div>
                        </div>
                    </fieldset>
                    ...
                    <fieldset>
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" type="text" class="form-control" name="mobile" value="{{$item->mobile}}" placeholder="{{__('cp.mobile')}}" {{ old('mobile') }} required>
                            </div>
                        </div>
                    </fieldset>
     ...
     <fieldset>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">  
                                        <select name="country_id" id="country_id" class="form-control countryEditForm">
  ...
  <fieldset>
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="text" class="form-control" name="address" placeholder="{{__('cp.address')}}" value="{{ $item->address}}" required>            
                            </div>
                        </div>
                    </fieldset>
                                    ...
                                    <div class="col-md-6">  
                                        ...
                                        @if(isset($zones))
                                            @foreach($zones as $one)
                                                <option @if($item->zone_id == $one->id) selected @endif value="{{$one->id}}">{{$one->name}}</option>
                                            @endforeach   
                                            @endif
                                        </select>           
                                    </div>
