        ...
        <div class="portlet-body">
            <div class="table-toolbar">
                <div class="row">
                    <div class="col-sm-9">
                        <div class="btn-group">
                            <a href="{{url(getLocal().'/admin/role/create')}}" style="margin-right:5px" class="btn sbold green">
                               {{__('cp.add')}}
            ...
            <input type="hidden" id="url" value="{{url(app()->getLocale()."/admin/changeStatus/role")}}">
                    ...
                    <tr class="odd gradeX" id="tr-{{$item->id}}">
                        ...
                        <td>
                            <div class="btn-group btn-action">
                                <a href="{{url(getLocal().'/admin/role/'.$item->id.'/edit')}}" class="btn btn-xs blue tooltips" data-container="body" data-placement="top" data-original-title="{{__('cp.edit')}}">
