...
@section('title') {{ucwords(__('cp.contenders'))}}
@endsection
@section('css')
@endsection
@section('content')
        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    <form method="post" action="{{url(app()->getLocale().'/admin/contenders/'.$item->id)}}" enctype="multipart/form-data" class="form-horizontal" role="form">
                        {{ csrf_field() }}
                        {{ method_field('PATCH')}}
                        <div class="form-body">
                            ...
                            <div class="form-actions">
                                <div class="row">
                                    <div class="col-md-offset-3 col-md-9">
                                        ...
                                        <a href="{{url(getLocal().'/admin/contenders')}}" class="btn default">
                                            {{__('cp.cancel')}}
                                        </a>
                                    </div>
                                </div>
