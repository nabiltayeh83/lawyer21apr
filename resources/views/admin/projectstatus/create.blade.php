        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    <form method="post" action="{{url(app()->getLocale().'/admin/projectstatus')}}" enctype="multipart/form-data" class="form-horizontal" role="form" id="form_category">
                    {{ csrf_field() }}
                        <div class="form-body">
