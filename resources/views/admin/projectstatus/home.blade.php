        ...
        <div class="portlet-body">
            <div class="table-toolbar">
                ...
                <div class="row">
                    <div class="col-sm-9">
                        <div class="btn-group">
                            <a href="{{url(getLocal().'/admin/projectstatus/create')}}" style="margin-right: 5px" class="btn sbold green">
                               {{__('cp.add')}}
                ...
                <div class="box-filter-collapse">
                    <form class="form-horizontal" method="get" action="{{url(getLocal().'/admin/projectstatus')}}">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="row">
            ...
            <input type="hidden" id="url" value="{{url(app()->getLocale()."/admin/changeStatus/projectstatus")}}">
                    ...
                    <tr class="odd gradeX" id="tr-{{$item->id}}">
                        ...
                        <td>
                            <div class="btn-group btn-action">
                                <a href="{{url(getLocal().'/admin/projectstatus/'.$item->id.'/edit')}}"
...
@section('script')
    <script>
        ...
        function delete_adv(id,iss_id, e) {
            ...
            console.log(id);
            console.log(iss_id);
            var url = '{{url(getLocal()."/admin/projectstatus")}}/' + id;
