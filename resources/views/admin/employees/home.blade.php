        ...
        <div class="portlet-body">
            <div class="table-toolbar">
                <div class="row">
                    <div class="col-sm-9">
                        <div class="btn-group">
                            <a href="{{url(app()->getLocale().'/admin/employees/create')}}" style="margin-right: 5px" class="btn sbold green">
                            ...
                            <div class="col-md-4">
                                <div class="row">
                                    <div class="col-md-offset-3 col-md-9">
                                        ...
                                        <a href="{{url('admin/employees')}}" type="submit" class="btn sbold btn-default ">
                                            {{__('cp.reset')}}
...
@section('script')
    <script>
        ...
        function delete_adv(id, iss_id, e) {
            ...
            console.log(id);
            console.log(iss_id);
            var url = '{{url(getLocal()."/admin/employees")}}/' + id;
