        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    <form method="post" action="{{url(app()->getLocale().'/admin/employees')}}" enctype="multipart/form-data" class="form-horizontal" role="form" id="form" >
                        {{ csrf_field() }}
                        ...
                        <fieldset>
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control" name="name" placeholder="{{__('cp.full_name')}}"  value="{{old('name')}}" required>
                                </div>
                            </div>
                        </fieldset>
