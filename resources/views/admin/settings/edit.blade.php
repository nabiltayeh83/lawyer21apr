        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    <form method="post" action="{{url(app()->getLocale().'/admin/settings')}}" enctype="multipart/form-data" class="form-horizontal" role="form">
                    {{ csrf_field() }}
                        <div class="form-body">
                            ...
                            <fieldset>
                             ...
                             <fieldset>
                                <div class="form-group" id="gover_option">
                                   ...
                                   <div class="col-md-6">
                                       <select id="multiple2" class="form-control select2" name="time_from">
                             ...
                             <fieldset>
                                <div class="form-group" id="gover_option">
                                   ...
                                   <div class="col-md-6">
                                       <select id="multiple2" class="form-control select2" name="time_to">
                                            <option value="">{{__('cp.time')}}</option>
                                            @for($i=00; $i<24 ; $i++)
                            ...
                            <fieldset>
                                <legend>{{__('cp.logo_white')}}</legend>
                                <div class="form-group">
                                    <div class="col-md-6 col-md-offset-3">
                                        <div class="fileinput-new thumbnail"
                                             onclick="document.getElementById('edit_logo_white').click()"
                                             style="cursor:pointer">
                                            <img src="{{url($item->logo_white)}}" id="editlogo_white">
                                        </div>
                                        <div class="btn red"
                                             onclick="document.getElementById('edit_logo_white').click()">
                                            <i class="fa fa-pencil"></i>{{__('cp.change_image')}}
                            ...
                            <fieldset>
                                <legend>{{""}}</legend>
                                <input id="searchInput" class="input-controls" type="text" placeholder="{{__('cp.search')}}">
...
@section('script')
    <script>
        ...
        $('#edit_logo_white').on('change', function (e) {
            readURL(this, $('#editlogo_white'));
        });
