            ...
            <table id="customers">
                <thead>
                    <tr>
                        ...
                        <th style="width:15%;">{{__('website.expense_date')}}</th>
                        <th style="width:20%;">{{__('website.expense_aspect')}}</th>
                        <th style="width:25%;">{{__('website.project_name')}}</th>
                        <th style="width:25%;">{{__('website.recipient_name')}}</th>
                ...
                <tbody>
                    ...
                    <td><span>{{$loop->iteration}}- </span></td>
                        ...
                        <td>{{@$one->aspect_expense->name}}</td>
                        <td>{{@$one->project->name}}</td>
