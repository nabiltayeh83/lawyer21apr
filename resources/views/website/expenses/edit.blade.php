...
<div class="page-top-fixed">
    <div class="container-fluid">
        <div class="px-3 pb-2 p-md-0 d-flex flex-column flex-md-row align-items-md-center justify-content-between">
            <h2 class="page-header mb-1 my-md-3">{{__('website.edit')}} {{__('website.expenses')}}</h2>
    ...
    <div class="bg-white">
        <div class="container-fluid">
            <ol class="breadcrumb breadcrumb-alt">
                ...
                <li class="breadcrumb-item active">{{__('website.edit')}} {{__('website.expenses')}}</li>
            </ol>
        </div>
    </div>
    <div class="container-fluid">
        <div class="row no-gutters mt-4">
            <div class="col-lg-12">
			    <form action="{{url(app()->getLocale() . '/expenses/' . $item->id)}}" method="post" id="editTaskForm" autocomplete="off" enctype="multipart/form-data">
                {{csrf_field()}}
                {{method_field('PUT')}}
                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-8">
                                    ...
                                    <div class="userDetails animated fadeIn delay-0.5s">
                                    			    ...
                                    			    <select class="full-width" data-init-plugin="select2" id="aspect_expense_id" name="aspect_expense_id" required>
                                    				    <optgroup label="{{__('website.select_expense_aspect')}}">
                                    					    ...
                                    					    @foreach($aspect_expense as $one)
                                    						    <option {{(@$item->aspect_expense_id == @$one->id)? 'selected':''}} value="{{@$one->id}}">{{@$one->name}}</option>
                                    					    @endforeach
                                    					    @endif
                                    			        </optgroup>
                                    		        </select>
                                        ...
                                        <div class="form-group mb-3 row">
                                        	...
                                        	<div class="col-md-7">
                                                <div class="form-group form-group-default required">
                                                    ...
                                                    <input type="text" class="form-control" id="reference_number" value="{{ @$item->reference_number }}"  name="reference_number">
                                        		</div>
                                        	</div>
                                        </div>
                                        	...
                                        	<div class="col-md-7">
                                        		<div class="row">
                                        			<div class="form-group form-group-default required">
                                        				...
                                        				<input type="text" name="expense_date" value="{{ @$item->expense_date }}" class="form-control hijri-date-input" required>
                                        			</div>
                                        	    </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group mb-3 row">
                                        	...
                                        	<div class="col-md-7">
                                                <div class="form-group form-group-default required">
                                                    ...
                                                    <input type="text" class="form-control" id="total_amount" value="{{ @$item->total_amount }}"  required  name="total_amount">
                                        		</div>
                                        	</div>
                                        </div>
                                        ...
                                        <div class="form-group mb-3 row">
                                            <label for="fname" class="col-md-3 control-label bold fs-14">{{__('website.descriptipn')}}</label>
                                        	<div class="col-md-7">
                                        		<div class="form-group form-group-default">
                                        			<label>{{__('website.descriptipn')}}</label>
                                        			<textarea class="form-control" name="expense_details" id="expense_details" >{{ @$item->expense_details }}</textarea>
                                        		</div>
                                        	</div>
                                        </div>
                                        ...
                                        <div class="form-group mb-3 row">
                                        	...
                                        	<div class="col-md-7">
                                        		<div class="form-group form-group-default">
                                        			...
                                        			<textarea class="form-control" name="expense_office_details" id="expense_office_details">{{ @$item->expense_office_details }}</textarea>
                                        		</div>
                                        	</div>
                                        </div>
