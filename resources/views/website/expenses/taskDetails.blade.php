            ...
            <div class="page-options-btns">
               <div class="btn-group mb-2 m-md-3 mt-md-0 ml-2">
                    ...
                    <button type="button" class="btn btn-default has-icon">
				        ...
				        <span>
				            <a href="{{url(getLocal(). '/tasks/' . $item->id . '/edit')}}">{{__('website.edit')}}</a>
				        </span>
                    </button>
                </div>
				...
				<a data-target="#addHoursTask" data-toggle="modal">
                                            ...
                                            <div class="card-body pb-1">
                                                <div class="row dashboard-no-gutters">
                								    ...
                								    <div class="col-lg-12 secDataProject">
                									    <p>
                									        <strong>{{__('website.task_details')}}</strong>
        							    ...
        							    <tbody>
        								    <tr>
        								        <td class="v-align-middle wd-5p">
        									        <div class="checkbox checkMain text-center">5</div>
        								        </td>
        								        <td class="v-align-middle wd-20p">
        									        <a href="taskDetails.html">عرض سعر لقضية حصر إرث</a>
        								        </td>
        								        <td class="v-align-middle wd-20p">
        									        <a href="">سني جورج سكاكيني</a>
        								        </td>
                            	    ...
                            	    <table class="table table-hover tableWithSearch" id="tableWithSearch">
        							    <thead>
        							     ...
        							     <tbody>
        								    <tr>
        								        <td class="v-align-middle wd-5p">
        									        <div class="checkbox checkMain text-center">3</div>
        								        </td>
                								<td class="v-align-middle wd-15p">
                								...
                								<td class="v-align-middle wd-10p"><p>مسودة</p></td>
                								<td class="v-align-middle wd-15p"><p>11/09/2018</p></td>
        										<td class="v-align-middle wd-15p"><p>18 ساعة</p></td>
                							</tr>
                						</tbody>
        							</table>
                          	    </div>
                            	    ...
                            	    <table class="table table-hover tableWithSearch" id="tableWithSearch">
        							    <thead>
        								    <tr>
            									...
            									<th class="wd-20p" >{{__('website.attachment_name')}}</th>
            									<th class="wd-15p text-center" >{{__('website.attachment_name')}}</th>
            								</tr>
                                        </thead>
        							    ...
        							    <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="v-align-middle wd-45p"><a href="">{{$one->attachment_name}}</a></td>
