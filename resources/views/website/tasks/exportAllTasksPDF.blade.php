            ...
            <table id="customers">
                <thead>
                    <tr>
                        ...
                        <th style="width:30%;">{{__('website.task_name')}}</th>
                        <th style="width:30%;">{{__('website.project')}}</th>
                        <th style="width:15%;">{{__('website.delivery_date')}}</th>
                        <th style="width:15%;">{{__('website.task_status')}}</th>
                    </tr>
                </thead>
                <tbody>
