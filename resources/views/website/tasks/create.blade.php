...
<div class="userDetails animated fadeIn delay-0.5s">
    ...
    <div class="form-group mb-3 row">
        ...
        <div class="col-md-9">
            <div class="radio radio-success">
                ...
                <input type="radio" value="other" checked name="task_category" required id="otherCategory1">
    ...
    <div class="form-group mb-3 row">
        ...
        <div class="col-md-7">
            <div class="form-group form-group-default">
                ...
                <input type="text" name="end_date" id="taskDate" class="form-control hijri-date-input taskDate">
            </div>
        </div>
    </div>

    <div class="form-group mb-3 row viewTasks hide">
        <label for="fname" class="col-md-3 control-label bold fs-14">{{__('website.tasks')}}</label>
        <div class="col-md-7">
            <div class="form-group form-group-default form-group-default-select2">
                <label class="">{{__('website.tasks')}}</label>
                <select class="full-width tasksSameDay" data-init-plugin="select2">
                </select>
            </div>
        </div>
    </div>
    ...
    <div class="form-group mb-3 d-flex align-items-center">
        ...
        <div class="col-md-7">
            <div class="radio radio-success">
                <input type="checkbox" value="yes" name="remind" id="checkNoti">
