            ...
            <table id="customers">
                <thead>
                    <tr>
                        ...
                        <th style="width:25%;">{{__('website.client_name')}}</th>
                        <th style="width:15%;">{{__('website.project_name')}}</th>
                        <th style="width:15%;">{{__('website.claim_date')}}</th>
                ...
                <tbody>
                    ...
                    <td><span>{{$loop->iteration}}- </span></td>
                        <td><span>{{ @$office_settings->invoices_number}}{{@$one->invoice_number}}</span></td>
