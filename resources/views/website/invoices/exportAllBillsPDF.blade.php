            ...
            <table id="customers">
                <thead>
                    <tr>
                        ...
                        <th style="width:15%;">{{__('website.billID')}}</th>
                        <th style="width:25%;">{{__('website.client_name')}}</th>
                        <th style="width:15%;">{{__('website.date')}}</th>
                        <th style="width:15%;">{{__('website.payment_methods')}}</th>
                ...
                <tbody>
                    ...
                    <td><span>{{$loop->iteration}}- </span></td>
                        ...
                        <td>{{Arr::get(getDates(substr($one->payment_date, 0, 10)), 'hijri_date')}}</td>
