    ...
    <htmlpageheader name="page-header">
        <div class="header">
            <div class="container">
              <div class="boxHeader">
                <div class="secHead">
                    <h3>{{__('website.project')}} / {{$item->name}}</h3>
                </div>
            ...
            <table id="customers">
                <thead>
                    <tr>
                        ...
                        <th style="width:16%;">{{__('website.hours')}}</th>
                        <th style="width:16%;">{{__('website.range')}}</th>
                        <th style="width:26%;">{{__('website.date')}}</th>
                        <th style="width:16%;">{{__('website.amount')}}</th>
                        <th style="width:16%;">{{__('website.status')}}</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <td><span>{{$loop->iteration}}- </span></td>
                        <td><span>{{@$one->hours_count}}</span></td>
                        <td>{{@$one->price}}</td>
                        <td>
            ...
            <table id="customers">
                <thead>
                    <tr>
                        ...
                        <th style="width:50%;">{{__('website.details')}}</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                    <td><span>{{$loop->iteration}}- </span></td>
                        <td><span>{{@$one->price}} {{__('website.sr')}}</span></td>
                        <td>
        ...
        <div class="container">
            ...
            <table id="customers">
                <thead>
                    <tr>
                        <th style="width:10%;">#</th>
                        <th style="width:40%;">{{__('website.title')}}</th>
                        <th style="width:25%;">{{__('website.date')}}</th>
                        <th style="width:25%;">{{__('website.status')}}</th>
                    </tr>
                </thead>
                <tbody>
