                                            			...
                                            			<select class="full-width" data-init-plugin="select2" id="task_type_id" name="task_type_id">
                                            				<optgroup label="{{__('website.select_task_type')}}">
                                            					...
                                            					@foreach($task_types as $one)
                                            						<option {{($item->task_type_id == $one->id)? 'selected':''}} value="{{@$one->id}}">{{@$one->name}}</option>
                                            					@endforeach
                                            				</optgroup>
                                            			</select>
                                            		</div>
                                            ...
                                            <div class="form-group mb-3 row">
                                            	...
                                            	<div class="col-md-7">
                                            		<div class="form-group form-group-default required">
                                            			...
                                            			<textarea class="form-control" name="details" id="details" required>{{@$item->details}}</textarea>
                                            		</div>
                                            	</div>
                                            </div>
                                            			...
                                            			<select class="full-width" data-init-plugin="select2" id="task_status_id" name="task_status_id">
                                            				<optgroup label="{{__('website.select_task_status')}}">
                                            					...
                                            					@foreach($task_status as $one)
                                            						<option {{($item->task_status_id == $one->id)? 'selected':''}} value="{{@$one->id}}">{{@$one->name}}</option>
                                            					@endforeach
                                            				</optgroup>
                                            			</select>
                                            		</div>
                                            		...
                                            		<div class="row">
                                            			<div class="col-md-6">
                                            				<div class="form-group form-group-default required">
                                            					...
                                            					<input type="text" name="start_date" value="{{@$item->start_date}}" class="form-control start_date">
                                            				</div>
                                            			</div>
                                            			<div class="col-md-6">
                                            				<div class="form-group form-group-default required">
                                            					<label>{{__('website.task_end_date')}}</label>
                                            					<input type="text" name="end_date" value="{{@$item->end_date}}" class="form-control end_date" required>
                                            				</div>
                                            			</div>
                                            		</div>
                                            	</div>
                                            			...
                                            			<select class="full-width" data-init-plugin="select2" id="workgroup_id" name="workgroup_id">
                                            				<optgroup label="{{__('website.choose_works_groups')}}">
                                            					...
                                            					@foreach($work_groups as $one)
                                            						<option {{($item->workgroup_id == $one->id)? 'selected':''}} value="{{@$one->id}}">{{@$one->name}}</option>
                                            				    @endforeach
                                            				</optgroup>
                                            			</select>
                                            		</div>
