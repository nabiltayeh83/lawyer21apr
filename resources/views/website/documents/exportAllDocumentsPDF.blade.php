            ...
            <table id="customers">
                <thead>
                    <tr>
                        ...
                        <th style="width:25%;">{{__('website.folder_title')}}</th>
                        <th style="width:25%;">{{__('website.project')}}</th>
                        <th style="width:15%;">{{__('website.date')}}</th>
                        <th style="width:25%;">{{__('website.entry_folder')}}</th>
                    </tr>
                </thead>
                <tbody>
