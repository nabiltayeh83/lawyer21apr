...
<div class="page-top-fixed">
    <div class="container-fluid">
        <div class="px-3 pb-2 p-md-0 d-flex flex-column flex-md-row align-items-md-center justify-content-between">
            <h2 class="page-header mb-1 my-md-3"> {{__('website.add')}} {{__('website.report')}}</h2>
				...
				<div class="container-xs-height full-height">
				    ...
				    <div class="modal-body col-xs-height">
                        ...
                        <form method="post" action="javascript:void(0)" id="createReportExpenses">
                            <input type="hidden" class="reportExpenseID" name="project_id" value="">
                    ...
                    <div class="row-xs-height">
                        <div class="modal-body col-xs-height">
                            <form method="post" action="javascript:void(0)" id="createReportHours">
                                <input type="hidden" class="reportProjectID" name="project_id" value="">
                    ...
                    <div class="row-xs-height">
                        <div class="modal-body col-xs-height">
                            ...
                            <form method="post" action="javascript:void(0)" id="createReportTasks">
                                <input type="hidden" class="reportTaskID" name="project_id" value="">
    ...
    <div class="bg-white">
        <div class="container-fluid">
            <ol class="breadcrumb breadcrumb-alt">
                ...
                <li class="breadcrumb-item active">{{__('website.add_report')}}</li>
            </ol>
        </div>
    </div>
    <div class="container-fluid">
        <div class="row no-gutters mt-4">
            <div class="col-lg-12">
                <form action="{{url(app()->getLocale() . '/reports')}}" method="post" id="newTaskForm" autocomplete="off" enctype="multipart/form-data">
                {{csrf_field()}}
                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-8">
                                	...
                                	<div class="form-group mb-3 row">
                                	    ...
                                	    <div class="col-md-7">
                                		    <div class="form-group form-group-default form-group-default-select2 required">
                                			    <label>{{__('website.project_name')}}</label>
                                				<select class="full-width reportMainProject" required name="project_id" id="project_id" data-init-plugin="select2">
                                				    <optgroup label="{{__('website.project_name')}}">
                                                        <option value=""></option>
                                                        @if(isset($projects))
                                    ...
                                    <div class="form-group mb-3 row selectProject">
                                    	<label for="fname" class="col-md-3 control-label bold fs-14">{{__('website.task')}}</label>
                                    	<div class="col-md-7">
                                    		<div class="form-group form-group-default form-group-default-select2 required">
                                    			<label>{{__('website.task')}}</label>
                                    			<select class="full-width reportProjectTasks" data-init-plugin="select2" id="task_id" required name="task_id">
                                    			</select>
                                    		</div>
                                    	</div>
                                    </div>
                                    ...
                                    <div class="form-group mb-3 row">
                                        ...
                                        <div class="col-md-7">
                                            <div class="form-group form-group-default">
                                                ...
                                                <input type="text" class="form-control hijri-date-input" name="next_date">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-3 row">
                                        ...
                                        <div class="col-md-7">
                                            <div class="form-group form-group-default">
                                                <label>{{__('website.time')}}</label>
                                                <input type="time" class="form-control next_time" name="next_time">
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover tableWithSearch" id="tableWithSearch">
        						    ...
        						    <tbody class="projectHours">
                                        @include('website.extraBlade.reports.projectHours')
        							</tbody>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover tableWithSearch" id="tableWithSearch">
        						    ...
        						    <tbody class="projectExpenses">
                                        @include('website.extraBlade.reports.projectExpenses')
        							</tbody>
        						</table>
                          	</div>
                        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover tableWithSearch" id="tableWithSearch">
        							...
        							<tbody class="projectTasks">
                                        @include('website.extraBlade.reports.projectTasks')
        						    </tbody>
        						</table>
                          	</div>
                        </div>
...
if($(".reportMainProject").val() != ''){
	$('.reportMainProject').change();
}



/////////////////////// View Cities ////////////////////
$(document).on('change','.reportMainProject',function(e){
    var project_id = $(this).val();
    var url = "{{ url(app()->getLocale().'/getProjectsTasks/') }}";
        ...
        $.ajax({
          ...
          success: function (response) {
              if(response)
              {
                ...
                $(".reportProjectTasks").empty();
                $(".reportProjectTasks").append('<optgroup label="{{__('website.select_project_name')}}">');
				$(".reportProjectTasks").append('<option value=""></option>');
                $.each(response, function(index, value){
                  $(".reportProjectTasks").append('<option value="'+value.id+'">'+ value.name +'</option>');
                  $(".reportProjectTasks").append('</optgroup>');
                });
